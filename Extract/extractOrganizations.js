...
var obj = JSON.parse(fs.readFileSync('../Datasets/organizations.json', 'utf8'), 1000);
...
async.eachSeries(obj, function(item, cb){
    ...
    async.series([
        ...
        if(err) console.log(err) // "another thing" 
            ...
            fs.writeFile('Extracted_Entities_organizations.json', JSON.stringify(obj), 'utf8', function(err){
